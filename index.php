...
<body>
<div class="top"><a href="index.php" style="text-decoration:none;"><span class="logo">Coffee Map</span> <span><img src="images/coffee.png" height="50px" width="50px"/></span></a><span><center><table><tr><td><form method="post" action="searchmap.php" target="main" id="sear"><input type="text" placeholder="Enter Street,City" id="txt" name="val"/></td><td><input type="submit" id="btn" value="find cafe" /></form></td></tr></table><input type="button" value="add | remove your shop" id="add" /></center></span></div>
<div>
